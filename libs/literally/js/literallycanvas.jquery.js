...
(function() {
    ...
    LC.ImageShape = function(_super) {
        ...
        ImageShape.prototype.imageX = 50;
        ImageShape.prototype.imageY = 50;
        ImageShape.prototype.imageWidth = null;
        ImageShape.prototype.imageHeight = null;
        ImageShape.prototype.imageRight = null;
        ImageShape.prototype.imageBottom = null;
        ImageShape.prototype.resizerRadius = null;
        ImageShape.prototype.rr = null;
...
//            return ctx.drawImage(this.image, this.x, this.y);
        ...
        ImageShape.prototype.hitImage = function(x, y) {
...
(function() {
    ...
    LC.Pan = function(_super) {
        ...
        Pan.prototype.begin = function(x, y, lc) {
            this.currentImage = lc.shapes[0];
            this.draggingResizer = this.currentImage.anchorHitTest(x, y);
            this.draggingImage = this.draggingResizer < 0 && this.currentImage.hitImage(x, y);
            return this.start = {
                x: x,
                y: y
            };
...
//            lc.pan(this.start.x - x, this.start.y - y);
            ...
            if (this.draggingResizer > -1) {
                ...
                switch (this.draggingResizer) {
                    case 0:
                        //top-left
                        this.currentImage.imageX = mouseX;
                        this.currentImage.imageWidth = this.currentImage.imageRight - mouseX;
                        this.currentImage.imageY = mouseY;
                        this.currentImage.imageHeight = this.currentImage.imageBottom - mouseY;
                        break;
                    case 1:
                        //top-right
                        this.currentImage.imageY = mouseY;
                        this.currentImage.imageWidth = mouseX - this.currentImage.imageX;
                        this.currentImage.imageHeight = this.currentImage.imageBottom - mouseY;
                        break;
                    case 2:
                        //bottom-right
                        this.currentImage.imageWidth = mouseX - this.currentImage.imageX;
                        this.currentImage.imageHeight = mouseY - this.currentImage.imageY;
                        break;
                    case 3:
                        //bottom-left
                        this.currentImage.imageX = mouseX;
                ...
                if(this.currentImage.imageWidth<25){this.currentImage.imageWidth=25;}
                if(this.currentImage.imageHeight<25){this.currentImage.imageHeight=25;}

                // set the image right and bottom
                this.currentImage.imageRight = this.currentImage.imageX + this.currentImage.imageWidth;
                this.currentImage.imageBottom = this.currentImage.imageY + this.currentImage.imageHeight;
...
//                this.currentImage.draw();
                ...
                var dx = mouseX - this.start.x;
                var dy = mouseY - this.start.y;
                this.currentImage.imageX += dx;
                this.currentImage.imageY += dy;
                this.currentImage.imageRight += dx;
                this.currentImage.imageBottom += dy;
...
//                this.currentImage.draw();
            ...
            return lc.update(this.currentImage);
//            return lc.repaint();
        };
        Pan.prototype.end = function(x, y, lc) {
            return lc.saveShape(this.currentImage);
        };
        return Pan;
    }(LC.Tool);
